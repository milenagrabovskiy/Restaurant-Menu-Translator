"""Blueprint controller for endpoints" pertaining to restaurants"""
...
def get_restaurant_by_id(restaurant_id) -> Response:
...
def update_restaurant(restaurant_id) -> Response:
...
def delete_restaurant(restaurant_id: int) -> tuple[str, int]:
