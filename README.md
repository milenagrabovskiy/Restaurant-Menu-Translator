...
A separate `ws-deployment branch contains the changes needed to deploy the project to Amazon EC2. These include the browser UI, HTML templates, and deployment-specific configuration changes.
